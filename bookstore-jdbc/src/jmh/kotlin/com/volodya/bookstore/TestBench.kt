...
open class JmhBenchmarkInsertAuthor {
    ...
    lateinit var jdbcAuthorRepository: JdbcAuthorRepository
    private val ids = AtomicInteger(0)

    @Setup(Level.Trial)
    fun setup() {
        this.context = runApplication<BookstoreApplication> { setAdditionalProfiles("test") }
        jdbcAuthorRepository = context.getBean(JdbcAuthorRepository::class.java)
        truncateTables()
    }
